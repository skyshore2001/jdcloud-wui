...
var tmrBatch_;$(document).keydown(function(e){if(e.keyCode==17){m_batchMode=true;clearTimeout(tmrBatch_);tmrBatch_=setTimeout(function(){m_batchMode=false;tmrBatch_=null;},500);}});$(window).keyup(function(e){if(e.keyCode==17){m_batchMode=false;clearTimeout(tmrBatch_);}});self.batchOp=batchOp;function batchOp(obj,ac,jtbl,data,onBatchDone,forceFlag)
...
else{var dgOpt=jtbl.datagrid("options");var p1=dgOpt.url&&dgOpt.url.params;var p2=dgOpt.queryParams;queryParams=$.extend({},p1,p2);var p3=$.extend({},queryParams,{res:"count(*) cnt"});self.callSvr(obj+".query",p3,function(data1){confirmBatch(data1.d[0][0]);});}
...
return;loadOptions();return false;});}
