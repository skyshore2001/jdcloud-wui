...
function setFixedFields(jdlg,beforeShowOpt){self.formItems(jdlg.find(".wui-fixedField"),function(ji,name,it){var fixedVal=beforeShowOpt&&beforeShowOpt.objParam&&beforeShowOpt.objParam[name];if(fixedVal||fixedVal==''){it.setReadonly(ji,true);var forAdd=beforeShowOpt.objParam.mode==FormMode.forAdd;if(forAdd){it.setValue(ji,fixedVal);}}
else{it.setReadonly(ji,false);}});}
